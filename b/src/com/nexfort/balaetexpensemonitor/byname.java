...
//	Button buttonbhai;
		  ...
		  ListView lisView1 = (ListView)findViewById(R.id.listView1); 
			 ...
			 lisView1.setOnItemClickListener(new OnItemClickListener() {
					...
					//	String str= Long.toString(id);
		                  Intent startDayActivity = new Intent(byname.this, namedetails.class);
    ...
    public void bindView(View view, Context context, final Cursor cursor) {
    		...
    		TextView txtIDD = (TextView) view.findViewById(R.id.textView2);
    ...
    newView method will be reused again and again as you scroll the list.
    		...
    		public View newView(Context context, Cursor cursor, ViewGroup parent) {
    			...
    			View view = inflater.inflate(R.layout.item_layout_name, parent, false);
